@php(Debugbar::info($buildings))
@extends('layouts.dashboard', ['active' => 'buildings'])
@section('title', 'Mis Edificios')
@section('nav-link', route('buildings.index'))
@section('content')
    <div class="content-center">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <i class="fas fa-building" style="font-size: 6em"></i>
            </div>
            <br/>
            <div class="row justify-content-center">
                <h1> Mis Edificios </h1>
                                        ...
                                        @foreach($buildings as $building)
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
                                                    <button type="button" class="btn btn-info edit" style="display: inline-block" onclick="prepareEdit({{json_encode($building)}})" data-toggle="modal" data-target="#edit-modal">
                                                        <i class="fas fa-pen" style="margin: 0 0.25em 0 0.25em"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-danger" onclick="deleteEntry({{ $building -> id }})">
